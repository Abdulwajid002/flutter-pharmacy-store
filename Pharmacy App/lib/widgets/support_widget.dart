...
class AppWidget{
    ...
    return  Container(
      ...
      child: Material(
        ...
        child: Container(
          ...
          child: Center(child: Text(name, style: TextStyle(color: Colors.white, fontFamily: 'Poppins1', fontSize: 17.0),)),
        ),
      ),
    );
  }
  ...
  static TextStyle whiteTextStyle(double size){
    return  TextStyle(color: Colors.white, fontSize: size, fontFamily: "Poppins1");
  }
}